...
export async function GET(request: NextRequest) {
  ...
  // Normalize base app URL (remove any trailing slash)
  ...
  const scope =
    ...
    'write_online_store_navigation,read_online_store_navigation,read_products,read_content';
  ...
  const params = new URLSearchParams({
    ...
    state,
    // comment next line if you don't use per-user
